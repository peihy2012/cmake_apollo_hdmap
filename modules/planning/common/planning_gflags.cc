...
DEFINE_double(planning_loop_rate, 10, "Loop rate for planning node");
...
DEFINE_double(planning_upper_speed_limit, 1.0,
              "Maximum speed (m/s) in planning.");

DEFINE_double(planning_lower_speed_limit, 0.2,
...
DEFINE_double(speed_upper_bound, 1.0, "The highest speed allowed.");
...
DEFINE_double(default_cruise_speed, 0.5, "default cruise speed");
...
DEFINE_double(polynomial_speed_fallback_velocity, 0.5,
